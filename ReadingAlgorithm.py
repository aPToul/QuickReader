...
# For each article scraped, this code tokenizes the text and find word modifiers near keywords (subjects/objects of interest)
...
# A list of potential subjects/objects that can be modified, called "keywords"
